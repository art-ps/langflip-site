...
export const copy = Object.freeze({
  ru: Object.freeze({
    ...
    installEyebrow: "Три шага",
    installTitle: "Установите и продолжайте печатать",
    installLead: "Сборка подписана сертификатом Developer ID и нотаризована Apple — запускается обычным двойным кликом.",
    install1Title: "Перенесите приложение",
    install1Body: "Откройте DMG и перетащите LangFlip в папку Applications.",
    install2Title: "Разрешите доступ",
    install2Body: "Включите Input Monitoring и Accessibility. Микрофон нужен только для диктовки.",
    install3Title: "Выберите раскладки",
    install3Body: "Укажите русскую и английскую раскладки и при желании загрузите речевую модель.",
  ...
  en: Object.freeze({
    ...
    installEyebrow: "Three steps",
    installTitle: "Install it and keep typing",
    installLead: "The build is signed with Developer ID and notarized by Apple, so it opens with a normal double click.",
    install1Title: "Move the app",
    install1Body: "Open the DMG and drag LangFlip into your Applications folder.",
    install2Title: "Grant access",
    install2Body: "Enable Input Monitoring and Accessibility. The microphone is only needed for dictation.",
    install3Title: "Pick your layouts",
    install3Body: "Choose the Russian and English layouts, and download the speech model if you want dictation.",
